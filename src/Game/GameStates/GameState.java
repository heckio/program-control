...
public class GameState extends State {
    ...
    public void refresh() {
        ...
        uiManager.addObjects(new UIImageButton(((handler.getWidth() / 2)) - ((handler.getWidth() / 16)) , (handler.getHeight() /2)-(handler.getHeight() /150), handler.getWidth()/8, handler.getHeight()/14, Images.title, new ClickListlener() {
            @Override
            public void onClick() {
                handler.getMouseManager().setUimanager(null);
